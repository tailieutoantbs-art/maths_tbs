          ...
          <div className="space-y-8 animate-fadeIn">
            ...
            <div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  <Link href="/ai-assistant" className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all hover:-translate-y-1 group border-l-4 border-l-purple-500">
                    <div className="text-3xl mb-3">🧠</div>
                    <h4 className="font-bold text-gray-800 text-lg mb-2">Trợ lý AI Năng Lực Số</h4>
                    <p className="text-sm text-gray-500">Tích hợp AI để thiết kế giáo án bài giảng mang định hướng phát triển năng lực số.</p>
                  </Link>

                  <Link href="/plan-assistant" className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all hover:-translate-y-1 group border-l-4 border-l-blue-500">
                    <div className="text-3xl mb-3">📅</div>
                    <h4 className="font-bold text-gray-800 text-lg mb-2">Trợ lý Kế Hoạch (Plan)</h4>
                    <p className="text-sm text-gray-500">Xử lý Phụ lục 1, 2, 3: Lập kế hoạch dạy học, phân phối chương trình và ma trận đề.</p>
                  </Link>
                  ...
                  <Link href="/editor" className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all hover:-translate-y-1 group border-l-4 border-l-indigo-500">
                    ...
                    <h4 className="font-bold text-gray-800 text-lg mb-2">Trình Biên Soạn TBS</h4>
                    <p className="text-sm text-gray-500">Không gian soạn thảo văn bản Toán học độc lập, kết xuất file chuẩn Word và LaTeX.</p>
                  </Link>
               </div>
            </div>
            ...
            <div>
               <h3 className="text-xl font-extrabold text-emerald-700 mb-4 flex items-center gap-2 border-b-2 border-emerald-100 pb-2 mt-8">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  ...
                  <Link href="/exams" className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all hover:-translate-y-1 group border-l-4 border-l-emerald-500">
                    <div className="text-3xl mb-3">📝</div>
                    <h4 className="font-bold text-gray-800 text-lg mb-2">Ngân Hàng Đề Thi</h4>
                    <p className="text-sm text-gray-500">Tạo Prompt ép AI sinh câu hỏi chuẩn JSON, duyệt mã LaTeX và lưu vào kho đề trắc nghiệm.</p>
                  </Link>
            ...
            <div>
               <h3 className="text-xl font-extrabold text-orange-600 mb-4 flex items-center gap-2 border-b-2 border-orange-100 pb-2 mt-8">
                 🏆 HOẠT ĐỘNG ĐẶC THÙ
               </h3>
               <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <Link href="/games/setup" className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all hover:-translate-y-1 group border-l-4 border-l-cyan-500 flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Thiết lập tham số đếm ngược, luật chơi và phân phối câu hỏi Gamification.</p>
                    </div>
                  </Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Link href="/games" className="group block bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl p-6 text-white shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-bold mb-2">CLB VUI HỌC TOÁN - TBS</h3>
