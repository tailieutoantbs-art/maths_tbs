      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="bg-white/60 backdrop-blur-xl border border-white/80 p-6 rounded-3xl shadow-lg flex flex-col md:flex-row justify-between items-center gap-4 relative overflow-hidden">
          ...
          <div className="flex gap-3 z-10">
            ...
            <button className="px-6 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-400 text-white font-extrabold rounded-xl shadow-[0_4px_0_0_#047857] active:translate-y-1 active:shadow-[0_0px_0_0_#047857] transition-all text-xs uppercase tracking-wider">
              🚀 Đăng Công Khai
            </button>
          </div>
        </div>
