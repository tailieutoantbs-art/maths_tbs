...
export default function GameLobbyPage() {
  ...
  // Xử lý khi học sinh bấm "Vào Phòng"
  const handleJoinGame = (e: React.FormEvent) => {
    ...
    setIsJoining(true);
    // Giả lập độ trễ kết nối mạng để tạo cảm giác hồi hộp
    setTimeout(() => {
      // Chuyển hướng học sinh vào phòng chơi tương ứng với mã PIN
